...
const Constant _consts[] = {
    ...
    mkEntry(CKM_RSA_PKCS_PSS, Mechanism),
    mkEntry(CKM_SHA1_RSA_PKCS_PSS, Mechanism),
    ...
    mkEntry(CKM_X9_42_DH_KEY_PAIR_GEN, Mechanism),
    ...
    mkEntry(CKM_SHA256_RSA_PKCS_PSS, Mechanism),
    mkEntry(CKM_SHA384_RSA_PKCS_PSS, Mechanism),
    mkEntry(CKM_SHA512_RSA_PKCS_PSS, Mechanism),
    mkEntry(CKM_SHA224_RSA_PKCS, Mechanism),
    mkEntry(CKM_SHA224_RSA_PKCS_PSS, Mechanism),
    ...
    mkEntry(CKM_SHA224, Mechanism),
    mkEntry(CKM_SHA224_HMAC_GENERAL, Mechanism),
    mkEntry(CKM_SHA224_HMAC, Mechanism),
    ...
    mkEntry(CKM_SHA224_KEY_DERIVATION, Mechanism),
    ...
    mkEntry(CKM_WTLS_PRE_MASTER_KEY_GEN, Mechanism),
    mkEntry(CKM_WTLS_MASTER_KEY_DERIVE, Mechanism),
    mkEntry(CKM_WTLS_MASTER_KEY_DERIVE_DH_ECC, Mechanism),
    mkEntry(CKM_WTLS_PRF, Mechanism),
    mkEntry(CKM_WTLS_SERVER_KEY_AND_MAC_DERIVE, Mechanism),
    mkEntry(CKM_WTLS_CLIENT_KEY_AND_MAC_DERIVE, Mechanism),
    mkEntry(CKM_TLS12_MASTER_KEY_DERIVE, Mechanism),
    mkEntry(CKM_TLS12_KEY_AND_MAC_DERIVE, Mechanism),
    mkEntry(CKM_TLS12_MASTER_KEY_DERIVE_DH, Mechanism),
    mkEntry(CKM_TLS12_KEY_SAFE_DERIVE, Mechanism),
    mkEntry(CKM_TLS_MAC, Mechanism),
    mkEntry(CKM_TLS_KDF, Mechanism),
    mkEntry(CKM_KEY_WRAP_LYNKS, Mechanism),
    mkEntry(CKM_KEY_WRAP_SET_OAEP, Mechanism),
    mkEntry(CKM_CMS_SIG, Mechanism),
    ...
    mkEntry(CKM_AES_CTR, Mechanism),
    mkEntry(CKM_AES_GCM, Mechanism),
    mkEntry(CKM_AES_CCM, Mechanism),
    mkEntry(CKM_AES_CTS, Mechanism),
    mkEntry(CKM_BLOWFISH_KEY_GEN, Mechanism),
    mkEntry(CKM_BLOWFISH_CBC, Mechanism),
    mkEntry(CKM_TWOFISH_KEY_GEN, Mechanism),
    mkEntry(CKM_TWOFISH_CBC, Mechanism),
    ...
    mkEntry(CKM_CAMELLIA_ECB_ENCRYPT_DATA, Mechanism),
    mkEntry(CKM_CAMELLIA_CBC_ENCRYPT_DATA, Mechanism),
    ...
    mkEntry(CKM_DES_ECB_ENCRYPT_DATA, Mechanism),
    mkEntry(CKM_DES_CBC_ENCRYPT_DATA, Mechanism),
    mkEntry(CKM_DES3_ECB_ENCRYPT_DATA, Mechanism),
    mkEntry(CKM_DES3_CBC_ENCRYPT_DATA, Mechanism),
    mkEntry(CKM_AES_ECB_ENCRYPT_DATA, Mechanism),
    mkEntry(CKM_AES_CBC_ENCRYPT_DATA, Mechanism),
    mkEntry(CKM_DSA_PARAMETER_GEN, Mechanism),
    mkEntry(CKM_DH_PKCS_PARAMETER_GEN, Mechanism),
    mkEntry(CKM_X9_42_DH_PARAMETER_GEN, Mechanism),
    mkEntry(CKM_NSS_AES_KEY_WRAP, Mechanism),
    mkEntry(CKM_NSS_AES_KEY_WRAP_PAD, Mechanism),
    mkEntry(CKM_NSS_HKDF_SHA1, Mechanism),
    mkEntry(CKM_NSS_HKDF_SHA256, Mechanism),
    mkEntry(CKM_NSS_HKDF_SHA384, Mechanism),
    mkEntry(CKM_NSS_HKDF_SHA512, Mechanism),
    mkEntry(CKM_NSS_JPAKE_ROUND1_SHA1, Mechanism),
    mkEntry(CKM_NSS_JPAKE_ROUND1_SHA256, Mechanism),
    mkEntry(CKM_NSS_JPAKE_ROUND1_SHA384, Mechanism),
    mkEntry(CKM_NSS_JPAKE_ROUND1_SHA512, Mechanism),
    mkEntry(CKM_NSS_JPAKE_ROUND2_SHA1, Mechanism),
    mkEntry(CKM_NSS_JPAKE_ROUND2_SHA256, Mechanism),
    mkEntry(CKM_NSS_JPAKE_ROUND2_SHA384, Mechanism),
    mkEntry(CKM_NSS_JPAKE_ROUND2_SHA512, Mechanism),
    mkEntry(CKM_NSS_JPAKE_FINAL_SHA1, Mechanism),
    mkEntry(CKM_NSS_JPAKE_FINAL_SHA256, Mechanism),
    mkEntry(CKM_NSS_JPAKE_FINAL_SHA384, Mechanism),
    mkEntry(CKM_NSS_JPAKE_FINAL_SHA512, Mechanism),
    mkEntry(CKM_NSS_HMAC_CONSTANT_TIME, Mechanism),
    mkEntry(CKM_NSS_SSL3_MAC_CONSTANT_TIME, Mechanism),
    mkEntry(CKM_NSS_TLS_PRF_GENERAL_SHA256, Mechanism),
    mkEntry(CKM_NSS_TLS_MASTER_KEY_DERIVE_SHA256, Mechanism),
    mkEntry(CKM_NSS_TLS_KEY_AND_MAC_DERIVE_SHA256, Mechanism),
    mkEntry(CKM_NSS_TLS_MASTER_KEY_DERIVE_DH_SHA256, Mechanism),
    mkEntry(CKM_NSS_TLS_EXTENDED_MASTER_KEY_DERIVE, Mechanism),
    mkEntry(CKM_NSS_TLS_EXTENDED_MASTER_KEY_DERIVE_DH, Mechanism),
    mkEntry(CKM_NSS_CHACHA20_KEY_GEN, Mechanism),
    mkEntry(CKM_NSS_CHACHA20_POLY1305, Mechanism),
    mkEntry(CKM_NSS_PKCS12_PBE_SHA224_HMAC_KEY_GEN, Mechanism),
    mkEntry(CKM_NSS_PKCS12_PBE_SHA256_HMAC_KEY_GEN, Mechanism),
    mkEntry(CKM_NSS_PKCS12_PBE_SHA384_HMAC_KEY_GEN, Mechanism),
    mkEntry(CKM_NSS_PKCS12_PBE_SHA512_HMAC_KEY_GEN, Mechanism),
    ...
    mkEntry(CKR_NSS_CERTDB_FAILED, Result),
    mkEntry(CKR_NSS_KEYDB_FAILED, Result),
